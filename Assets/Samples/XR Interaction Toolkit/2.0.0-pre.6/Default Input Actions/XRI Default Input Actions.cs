...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Skratch"",
                    ""type"": ""Button"",
                    ""id"": ""6e4d626f-57e4-4ba9-8b08-743f23afdbb2"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""be180f89-1e02-474a-968c-0d2421d99572"",
    ...
    ""controlSchemes"": [
        ...
        m_XRIRightHand_Skratch = m_XRIRightHand.FindAction("Skratch", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRIRightHand_Skratch;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @Skratch => m_Wrapper.m_XRIRightHand_Skratch;
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @Skratch.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnSkratch;
                @Skratch.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnSkratch;
                @Skratch.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnSkratch;
            }
            ...
            if (instance != null)
            {
                ...
                @TranslateAnchor.performed += instance.OnTranslateAnchor;
                @TranslateAnchor.canceled += instance.OnTranslateAnchor;
                @Skratch.started += instance.OnSkratch;
                @Skratch.performed += instance.OnSkratch;
                @Skratch.canceled += instance.OnSkratch;
            }
        }
    }
    ...
    public interface IXRIRightHandActions
    {
        ...
        void OnRotateAnchor(InputAction.CallbackContext context);
        void OnTranslateAnchor(InputAction.CallbackContext context);
        void OnSkratch(InputAction.CallbackContext context);
    }
}
